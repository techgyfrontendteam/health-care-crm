...
import { Eye, Pencil, Trash2, Stethoscope, ChevronLeft, ChevronRight, Loader2 } from "lucide-react";
        ...
        <table className="min-w-full border-collapse text-left text-sm">
          <thead className="sticky top-0 z-20 bg-[#F8F9FA] dark:bg-zinc-900 shadow-[0_1px_2px_rgba(0,0,0,0.04)]">
            <tr className="border-b border-zinc-200 dark:border-zinc-800 text-[11px] font-bold text-gray-500 dark:text-zinc-400 uppercase tracking-wider">
              ...
              <th className="py-3 px-4 whitespace-nowrap bg-[#F8F9FA] dark:bg-zinc-900">Status</th>
            ...
            {isLoading ? (
              Array.from({ length: 8 }).map((_, i) => (
                <tr key={i} className="animate-pulse">
                  ...
                  <td className="py-3 px-4"><div className="h-3 bg-zinc-100 dark:bg-zinc-800 rounded w-20" /></td>
                  <td className="py-3 px-4"><div className="h-5 bg-zinc-100 dark:bg-zinc-800 rounded-full w-14" /></td>
                  <td className="py-3 px-4 text-right"><div className="h-6 bg-zinc-100 dark:bg-zinc-800 rounded w-16 ml-auto" /></td>
                </tr>
              ))
            ) : doctors.length === 0 ? (
              <tr>
                <td colSpan={8} className="py-20 text-center text-zinc-400">
                  ...
                  <td className="py-3 px-4 whitespace-nowrap">
                    <span
                      className={cn(
                        ...
                        doc.is_active === 1
                          ? "bg-emerald-50 text-emerald-700 border-emerald-200/80 dark:bg-emerald-950/40 dark:text-emerald-300 dark:border-emerald-900"
                    ...
                    >
                      <span
                        className={cn(
                          ...
                          doc.is_active === 1 ? "bg-emerald-500" : "bg-zinc-400"
                        )}
                      />
