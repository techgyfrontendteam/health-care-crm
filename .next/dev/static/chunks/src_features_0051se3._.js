...
const BulkActionsBar = ({ selectedCount, rms, ems, onAssignRm, onAssignEm, onMarkAsJunk: _onMarkAsJunk, onCancel, isLoading: _isLoading, showAssignRm = true, showAssignEm = false })=>{
    ...
    const { currentRole } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$usePermissions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePermissions"])();
...
const LeadForm = ({ onSubmit, isLoading, initialValues, isEdit = false })=>{
    _s();
    const { user: currentUser, roleCode } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$usePermissions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePermissions"])();
...
const LeadTable = ({ data, isLoading, page, limit, total, onPageChange, onLimitChange, onEdit, onDelete, onScheduleVisit, onUpdateStatus, onAssignRm, onAssignEm, sortField, sortOrder, onSort, selectedUuids = [], onSelectUuids, offset = 0, maxHeight, containerHeight = '85vh' })=>{
    ...
    const { currentRole, can } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$usePermissions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePermissions"])();
    const roleCode = currentRole?.code || '';
...
"[project]/src/features/leads/data/demoLeads.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const demoLeads = [
    {
        uuid: "demo-lead-2001",
        lead_id: 2001,
        customer_uuid: "demo-customer-2001",
        project_id: 1,
        source_id: 1,
        source: "Website",
        source_employee_user_id: null,
        lead_status_id: 1,
        project_lead_status_id: 1,
        lead_priority_id: 1,
        assigned_to_rm: null,
        assigned_to_em: null,
        is_active: 1,
        created_by: 1,
        created_on: "2026-09-16T08:45:00.000Z",
        updated_by: null,
        updated_on: null,
        first_name: "Aarav",
        last_name: "Sharma",
    ...
    },
    {
        uuid: "demo-lead-2002",
        lead_id: 2002,
        customer_uuid: "demo-customer-2002",
        project_id: 2,
        source_id: 2,
        source: "Doctor Referral",
        source_employee_user_id: null,
        lead_status_id: 2,
        project_lead_status_id: 2,
        lead_priority_id: 2,
        assigned_to_rm: null,
        assigned_to_em: null,
        is_active: 1,
        created_by: 1,
        created_on: "2026-09-16T07:20:00.000Z",
        updated_by: null,
        updated_on: null,
        first_name: "Diya",
        last_name: "Reddy",
        phone_number: "+91 91234 56789",
        email_address: "diya.reddy@example.com",
    ...
    },
    {
        uuid: "demo-lead-2003",
        lead_id: 2003,
        customer_uuid: "demo-customer-2003",
        project_id: 3,
        source_id: 3,
        source: "Walk-in",
        source_employee_user_id: null,
        lead_status_id: 3,
        project_lead_status_id: 3,
        lead_priority_id: 1,
        assigned_to_rm: null,
        assigned_to_em: null,
        is_active: 1,
        created_by: 1,
        created_on: "2026-09-15T15:10:00.000Z",
        updated_by: null,
        updated_on: null,
        first_name: "Rohan",
        last_name: "Mehta",
        phone_number: "+91 99887 76655",
        email_address: "rohan.mehta@example.com",
    ...
    },
    {
        uuid: "demo-lead-2004",
        lead_id: 2004,
        customer_uuid: "demo-customer-2004",
        project_id: 4,
        source_id: 4,
        source: "Google Ads",
        source_employee_user_id: null,
        ...
        email_address: "ishita.nair@example.com",
        hospital_branch: "Nizampet",
        department: "Oncology",
    ...
    },
    {
        uuid: "demo-lead-2005",
        lead_id: 2005,
        customer_uuid: "demo-customer-2005",
        project_id: 1,
        source_id: 5,
        source: "WhatsApp",
        source_employee_user_id: null,
        lead_status_id: 4,
        project_lead_status_id: 4,
        lead_priority_id: 1,
        assigned_to_rm: 301,
        assigned_to_em: 401,
        is_active: 1,
        created_by: 1,
        created_on: "2026-09-15T10:35:00.000Z",
        updated_by: null,
        updated_on: null,
        first_name: "Kavya",
        last_name: "Iyer",
        phone_number: "+91 94444 55667",
        email_address: "kavya.iyer@example.com",
        hospital_branch: "Nizampet",
    ...
    },
    {
        uuid: "demo-lead-2006",
        lead_id: 2006,
        customer_uuid: "demo-customer-2006",
        project_id: 2,
        source_id: 2,
        source: "Doctor Referral",
        source_employee_user_id: null,
        lead_status_id: 5,
        project_lead_status_id: 5,
        lead_priority_id: 2,
        assigned_to_rm: 302,
        assigned_to_em: 402,
        is_active: 1,
        created_by: 1,
        created_on: "2026-09-14T16:25:00.000Z",
        updated_by: null,
        updated_on: null,
        first_name: "Aditya",
        last_name: "Menon",
    ...
    },
    {
        uuid: "demo-lead-2007",
        lead_id: 2007,
        customer_uuid: "demo-customer-2007",
        project_id: 3,
        source_id: 1,
        source: "Website",
        source_employee_user_id: null,
        lead_status_id: 6,
        project_lead_status_id: 6,
        lead_priority_id: 2,
        assigned_to_rm: 303,
        assigned_to_em: 403,
        is_active: 1,
        created_by: 1,
        created_on: "2026-09-14T11:40:00.000Z",
        updated_by: null,
        updated_on: null,
        first_name: "Meera",
        last_name: "Kapoor",
        phone_number: "+91 98760 12345",
        email_address: "meera.kapoor@example.com",
        hospital_branch: "KPHB",
    ...
    },
    {
        uuid: "demo-lead-2008",
        lead_id: 2008,
        customer_uuid: "demo-customer-2008",
        project_id: 4,
        source_id: 6,
        source: "Social Media",
        source_employee_user_id: null,
        lead_status_id: 7,
        project_lead_status_id: 7,
        lead_priority_id: 3,
        assigned_to_rm: 301,
        assigned_to_em: 404,
        is_active: 1,
        created_by: 1,
        created_on: "2026-09-13T09:15:00.000Z",
        updated_by: null,
        updated_on: null,
        first_name: "Vikram",
        last_name: "Shah",
        phone_number: "+91 98220 33445",
        email_address: "vikram.shah@example.com",
        hospital_branch: "Nizampet",
        department: "Dermatology",
        doctor_name: "Dr. Kavita Deshmukh",
        enquiries: 2,
        status: "Treatment discussed",
        rm_name: "Rahul Mehta"
    }
];
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$leads$2f$data$2f$demoLeads$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/leads/data/demoLeads.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
;
;
...
const LeadsPage = ()=>{
    ...
    const { currentRole, can, user: currentUser } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$usePermissions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePermissions"])();
    ...
    const leads = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useMemo({
        "LeadsPage.useMemo[leads]": ()=>{
            ...
            if (list.length === 0) {
                list = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$leads$2f$data$2f$demoLeads$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["demoLeads"].filter({
                    "LeadsPage.useMemo[leads]": (lead)=>{
    ...
    const isShowingDemoLeads = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useMemo({
        "LeadsPage.useMemo[isShowingDemoLeads]": ()=>{
...
_s(LeadsPage, "dQMBobgJq7tc0LGzXstmvvNtRgs=", false, function() {
    return [
...
//# sourceMappingURL=src_features_0051se3._.js.map