...
"[project]/src/features/master-data/pages/FollowUpStatusesPage.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "FollowUpStatusesPage",
    ()=>FollowUpStatusesPage
]);
...
const FollowUpStatusesPage = ()=>{
    ...
    const [createLeadFollowUpType] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$master$2d$data$2f$api$2f$manageMasterDataSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCreateLeadFollowUpTypeMutation"])();
    const [updateLeadFollowUpType] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$master$2d$data$2f$api$2f$manageMasterDataSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUpdateLeadFollowUpTypeMutation"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FollowUpStatusesPage.useEffect": ()=>{
            if (masterData?.lead_followup_types) {
                const apiStatuses = masterData.lead_followup_types.map({
                    "FollowUpStatusesPage.useEffect.apiStatuses": (t)=>({
                            code: t.code,
                            name: t.description || t.code,
                            id: t.id
                        })
                }["FollowUpStatusesPage.useEffect.apiStatuses"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FollowUpStatusesPage.useEffect": ()=>{
            ...
            if (isSaveSuccessModalOpen) {
                ...
                }["FollowUpStatusesPage.useEffect"], 3000);
            }
            return ({
                "FollowUpStatusesPage.useEffect": ()=>{
        ...
        try {
            if (modalMode === "add") {
                if (globalStatuses.some((s)=>s.code.toUpperCase() === cleanCode)) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(`Type code "${cleanCode}" already exists.`);
                    return;
                }
                if (globalStatuses.some((s)=>s.name.trim().toLowerCase() === cleanName.toLowerCase())) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(`Type name "${cleanName}" already exists.`);
                    return;
                }
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`Type "${cleanName}" added successfully.`);
            } else {
                if (!editingTypeId) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Invalid follow-up type ID.");
                    return;
                }
                ...
                setGlobalStatuses(globalStatuses.map((s)=>s.code === editingStatusCode ? {
                        ...s,
                        name: statusName.trim(),
                        code: cleanCode
                    } : s));
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Type updated successfully.");
            }
    ...
    // Computed data lists
    const displayedStatuses = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "FollowUpStatusesPage.useMemo[displayedStatuses]": ()=>{
            return globalStatuses.filter({
                "FollowUpStatusesPage.useMemo[displayedStatuses]": (s)=>s.name.toLowerCase().includes(searchQuery.toLowerCase()) || s.code.toLowerCase().includes(searchQuery.toLowerCase())
            }["FollowUpStatusesPage.useMemo[displayedStatuses]"]);
        }
    }["FollowUpStatusesPage.useMemo[displayedStatuses]"], [
        globalStatuses,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$arrow$2d$left$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ArrowLeft$3e$__["ArrowLeft"], {
                                ...
                                fileName: "[project]/src/features/master-data/pages/FollowUpStatusesPage.tsx",
                                lineNumber: 160,
                                columnNumber: 11
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                ...
                                children: "Available Follow-up Types"
                            }, void 0, false, {
                                fileName: "[project]/src/features/master-data/pages/FollowUpStatusesPage.tsx",
                                lineNumber: 194,
                                columnNumber: 11
                            }, ("TURBOPACK compile-time value", void 0)),
                            displayedStatuses.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: 'No follow-up types found. Click "Add New Type" above to create one.'
                            }, void 0, false, {
                                fileName: "[project]/src/features/master-data/pages/FollowUpStatusesPage.tsx",
                                lineNumber: 199,
                                columnNumber: 13
                                ...
                                children: displayedStatuses.map((status)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                    ...
                                    children: modalMode === "add" ? "Add New Type" : "Edit Type"
                                }, void 0, false, {
                                    fileName: "[project]/src/features/master-data/pages/FollowUpStatusesPage.tsx",
                                    lineNumber: 242,
                                    columnNumber: 15
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            ...
                                            children: modalMode === "add" ? "Add New Type" : "Update Type"
                                        }, void 0, false, {
                                            fileName: "[project]/src/features/master-data/pages/FollowUpStatusesPage.tsx",
                                            lineNumber: 297,
                                            columnNumber: 17
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: [
                                ...
                                " ",
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    className: "italic text-slate-455 dark:text-zinc-500",
                                    children: "Changes have been securely applied."
                                }, void 0, false, {
                                    fileName: "[project]/src/features/master-data/pages/FollowUpStatusesPage.tsx",
                                    lineNumber: 332,
                                    columnNumber: 15
...
_s(FollowUpStatusesPage, "ZGClbGwU6HRR7lYv1hQLaMEt3BI=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$master$2d$data$2f$api$2f$manageMasterDataSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCreateLeadFollowUpTypeMutation"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$master$2d$data$2f$api$2f$manageMasterDataSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUpdateLeadFollowUpTypeMutation"],
...
_c = FollowUpStatusesPage;
var _c;
__turbopack_context__.k.register(_c, "FollowUpStatusesPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_1p2r087._.js.map